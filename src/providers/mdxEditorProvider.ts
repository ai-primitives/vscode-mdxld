...
export class MDXEditorProvider implements vscode.CustomTextEditorProvider {
  ...
  public static register(context: vscode.ExtensionContext): vscode.Disposable {
    ...
    return vscode.window.registerCustomEditorProvider(MDXEditorProvider.viewType, provider, {
  ...
  async resolveCustomTextEditor(
    ...
    webviewPanel.webview.options = {
      enableScripts: true,
      localResourceRoots: [vscode.Uri.joinPath(this.context.extensionUri, 'media'), vscode.Uri.joinPath(this.context.extensionUri, 'dist')],
    }

    const monacoScriptUri = webviewPanel.webview.asWebviewUri(
      vscode.Uri.joinPath(this.context.extensionUri, 'node_modules', 'monaco-editor', 'min', 'vs', 'loader.js'),
    )
